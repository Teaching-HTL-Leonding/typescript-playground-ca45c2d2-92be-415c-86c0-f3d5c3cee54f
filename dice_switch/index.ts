function setup() {
    ...
    switch (dice) {
        ...
        case 2:
            ...
            break;
        case 3:
            circle(width/2,height*0.75, dicePointDiameter)
            circle( width/2, height/2,dicePointDiameter)
            circle(width/2, height*0.25, dicePointDiameter)
            break;
        case 4:
        circle(width*0.75,height*0.25,dicePointDiameter)
        circle(width*0.25,height*0.75,dicePointDiameter)
        circle(width*0.75,height*0.75,dicePointDiameter)
        circle(width*0.25,height*0.25,dicePointDiameter)
          break
        case 5:
        circle(width*0.75,height*0.25,dicePointDiameter)
        circle(width*0.25,height*0.75,dicePointDiameter)
        ...
        circle(width*0.75,height*0.75,dicePointDiameter)
        circle(width*0.25,height*0.25,dicePointDiameter)
        circle(width*0.25, height/2,dicePointDiameter)
